...
// Usage:
//
//    HSGIS.stopScrollingAtFooter.addEl($(node), $(node).height());
//
...
;(function (global) {
  ...
  var stopScrollingAtFooter = {
    ...
    addEl: function ($fixedEl, height) {
      ...
      $(global).on('HSGIS.pageSizeChanged', stopScrollingAtFooter.updateFooterTop)
  ...
  HSGIS.stopScrollingAtFooter = stopScrollingAtFooter

  $(global).load(function () { $(global).trigger('HSGIS.pageSizeChanged') })
