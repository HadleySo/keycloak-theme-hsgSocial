...
<#elseif section = "form">
    ...
    <div class="pf-c-alert pf-m-warning pf-m-inline ${properties.kcRecoveryCodesWarning!}" aria-label="Warning alert">
        ...
        <div class="pf-c-alert__description font-xsmall">
    ...
    <div class="${properties.kcRecoveryCodesActions!}">
        <button id="printRecoveryCodes" class="pf-c-button pf-m-link button button-alt" type="button">
            <i class="pficon-print"></i> ${msg("recovery-codes-print")}
        </button>
        <button id="downloadRecoveryCodes" class="pf-c-button pf-m-link button button-alt" type="button">
            <i class="pficon-save"></i> ${msg("recovery-codes-download")}
        </button>
        <button id="copyRecoveryCodes" class="pf-c-button pf-m-link button button-alt" type="button">
            <i class="pficon-blueprint"></i> ${msg("recovery-codes-copy")}
        </button>
    </div>

    <!-- confirmation checkbox -->
    <div class="${properties.kcFormOptionsClass!} multiple-choice" style="margin-top: 30px; margin-bottom: 10px;">
